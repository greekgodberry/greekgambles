...
export default function Socials() {
  return (
    <section id="socials" className="bg-black px-6 py-24 text-center text-white">
      ...
      <div className="mx-auto mt-10 grid max-w-5xl gap-5 md:grid-cols-3">
        {socials.map(([name, url]) => (
          <a
            ...
            href={url}
            target="_blank"
            className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6 text-xl font-black transition hover:border-red-500 hover:text-red-400"
          >
            {name}
          </a>
        ))}
